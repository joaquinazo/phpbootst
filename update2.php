...
<form class="form-horizontal" action="up2.php" method="post">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="clave" name="clave" type="hidden" placeholder="placeholder"  class="form-control input-md" value=<?php echo $clave; ?>  >
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="precio" name="precio" type="number" placeholder="placeholder"  class="form-control input-md" value=<?php echo $precio; ?>>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button  type="submit" id="singlebutton"  name="singlebutton" class="btn btn-warning boton" > Update</Button>
  </div>
</div>
